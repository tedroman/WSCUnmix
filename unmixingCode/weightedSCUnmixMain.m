function [V,A,data,VProj,M,I,E,K,CIp,Ps,Fs,RW,penDf,penPf,dimList] = weightedSCUnmixMain(data,theta,gamma,c,sigma)
...
if length(CIInt) > 1
    ...
    for i = 1:length(CIInt)
       currInt  = CIInt(i);
       [V,A,VProj,I,E,K,CIp,Ps,Fs,RW,M,penDf,penPf,dimList] = unmix1NumClus(numRep,numPts,repIdxAllReplicates,currInt,repsBase,theta,dataSCCoeffs,dataSCBase01Norm,h,dataSCBase,data,dataPCCoeff,gamma,c);
...
[V,A,VProj,I,E,K,CIp,Ps,Fs,RW,M,penDf,penPf,dimList]=unmix1NumClus(numRep,numPts,repIdxAllReplicates,CIInt,repsBase,theta,dataSCCoeffs,dataSCBase01Norm,h,dataSCBase,data,dataPCCoeff,gamma,c);
...
function[V,A,VProj,I,E,K,CIp,Ps,Fs,RW,M,penDf,penPf,dimList]=unmix1NumClus(numRep,numPts,repIdxAllReplicates,CIInt,repsBase,theta,dataSCCoeffs,dataSCBase01Norm,h,dataSCBase,data,dataPCCoeff,gamma,c)
