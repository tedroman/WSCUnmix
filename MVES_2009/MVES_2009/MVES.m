...
% MVES: estimate the minimum volume bounding N-simplex for a point set
%
% [C,Alphas, timing, iterations] = MVES(X, N, display_flag)
%  
% where : X = C*Alphas 
% 
% Assumes: 
...
% 
% Tsung-Han Chan, E-mail: chantsunghan@gmail.com 5/20/2009 
% Modified: David A. Toliver November 2009      
% 
...
%  unmixing," to appear IEEE Trans. Signal Processing, 2009. 
% 
...
%% Dimension reduction through affine set fitting-----------------
[M,L] = size(X);
d = mean(X,2);
U = X-d*ones(1,L);
R = U*U';
...
disp('Solving LPs'); 
%% Solving the two linear programs
